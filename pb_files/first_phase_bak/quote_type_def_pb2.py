...
_QUOTEMSGTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUTH_CENTER_LOGIN', index=67, number=600,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUTH_CENTER_AUTH', index=68, number=601,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUTH_CENTER_REFRESH', index=69, number=602,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUTH_CENTER_REVOKE', index=70, number=603,
      serialized_options=None,
      type=None),
  ],
