...
if __name__ == '__main__':
    ...
    fail_rerun_time = 0
    pytest_html_filename = report_folder + 'CalTestCases_PytestReport_' + str(now_time_stamp) + '.html'
    pytest_param_list = []
    pytest_param_list.append(SETUP_DIR + '/testcase/zmq_testcase/cal_future_testcase.py')  # 遍历的测试用例文件
    ...
    pytest_param_list.append('-k=CheckDbData')  # 跑订阅服务用例
