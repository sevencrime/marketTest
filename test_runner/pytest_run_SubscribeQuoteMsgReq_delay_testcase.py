...
if __name__ == '__main__':
    ...
    fail_rerun_time = 1
    pytest_html_filename = report_folder + 'SubscribeQuoteMsgReq_delay_testcase_PytestReport_' + str(now_time_stamp) + '.html'
    pytest_param_list = []
    pytest_param_list.append(SETUP_DIR + '/testcase/ws_testcase/SubscribeQuoteMsgReq_delay_testcase.py')  # 遍历的测试用例文件
